...
double computeCd_Re(double Re, double Cc){
	...
	{
		CdRE = 22.73 / Re + 0.0903 / Re / Re + 3.69;
	}
	else if (Re < 10.0)
	{
		CdRE = 29.1667 / Re - 3.8889 / Re / Re + 1.222;
	}
	else if (Re < 100.0)
	{
		CdRE = 46.5 / Re - 116.67 / Re / Re + 0.6167;
	}
	else if (Re < 1000.0)
	{
		CdRE = 98.33 / Re - 2778.0 / Re / Re + 0.3644;
	}
	else if (Re < 5000.0)
	{
		CdRE = 148.62 / Re - 47500.0 / Re / Re + 0.357;
	}
	else if (Re < 10000.0)
	{
		CdRE = -490.546 / Re + 578700.0 / Re / Re + 0.46;
	}
	else if (Re < 50000.0)
	{
		CdRE = -1662.5 / Re - 5416700.0 / Re / Re + 0.5191;
	}
	else
	{
		CdRE = 0.4;
